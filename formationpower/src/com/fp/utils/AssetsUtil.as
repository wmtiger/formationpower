...
{
	import com.fp.cfgs.AppCfg;
	
	import flash.filesystem.File;

	public class AssetsUtil
	{
		public static const FASD_PATH:String = File.applicationStorageDirectory.nativePath;
		...
		/**
		 * 获取头像图片的地址，用于判断并获取不同平台的地址
		 */
		public static function getHeadUrlByKey(key:String):String
		{
			return urlHead + "imgs/heads/" + key + ".jpg";
		}
